  ...
  return (
    <div>
      ...
      <ol>
        <li>Create A Game.</li>
        <li>
          Share the Game Details in Social chat platforms. Player can join the
          game using link.
        </li>
        <li>Player joined the game.</li>
        <li>
          Host has to generate tickets for the Players from his dashboard.
        </li>
        <li>Player has to reload until they get the ticket.</li>
        <li>Game Starts</li>
        <li>
          Player has to claim the offers it will be autochecked and points will
          be given.
        </li>
