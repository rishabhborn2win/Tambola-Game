...
exports.generateTicket = async () => {
    ...
    var accepetedNumbersRowThree = await validSetRowThree(accepetedNumbersRowOne, accepetedNumbersRowTwo);
    //now evaluate the index which has to be eliminated
    var rejectedNumbers = [];
    indexArray.map((num) => {
  ...
  function validSetRowTwo(acceptedNumbersRowOne){
    ...
    var countFirstRowTwo =0, countSecondRowTwo =0, countThirdRowTwo =0
    acceptedNumbers.map((num) => {
      if(num>=0 && num<=2) countFirstRowTwo++
      if(num>=3 && num<=5) countSecondRowTwo++
      if(num>=6 && num<=8) countThirdRowTwo++
    })
    }while(countFirst === 1 && countFirstRowTwo === 1 || countSecond === 1 && countSecondRowTwo === 1 || countThird === 1 && countThirdRowTwo === 1);
  ...
  function validSetRowThree(acceptedNumbersRowOne, acceptedNumbersRowTwo){
    ...
    var countFirstRowThree =0, countSecondRowThree =0, countThirdRowThree =0
    acceptedNumbers.map((num) => {
